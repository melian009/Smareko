...
r = unifrnd(0,200);%random landscape: r uniform 10 (all isolated sites),700 (all connected sites)
...
fid = fopen('RadiusDynamicLandscapes.txt','a');fprintf(fid, [repmat('% 6f',1,size(Zoe,2)), '\n'],Zoe);fclose(fid); 
end%ri
