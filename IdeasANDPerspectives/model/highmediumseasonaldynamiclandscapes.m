...
%Resources
newspeciesR = 1;R = ones(S,J);mr = unifrnd(0.1,0.2,1);vr = unifrnd(0.1,0.5,1);
%Consumers
newspeciesH = 1;H = ones(S,J);mh = unifrnd(0.1,0.2,1);vh = unifrnd(0.1,0.5,1);
%Predators
newspeciesP = 1;P = ones(S,J);mp = unifrnd(0.1,0.2,1);vp = unifrnd(0.1,0.5,1);
